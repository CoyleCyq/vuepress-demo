...
<style>
    ...
    .cart-list {position: absolute;top: 10px;right: 10px;padding: 10px;width: 200px;/*height: 400px;*/border: 1px solid #ddd;/*overflow-y:auto;*/}
    .cart-list h4 {margin: 0;padding-bottom: 5px;border-bottom: 1px solid #ddd;}
    .cart-list img {width: 60px;}
...
<body>
    <div class="goods-list">
        <h4>产品列表</h4>
        <ul>
            <li><img src="https://cyq0802.xin/img/demoImg/g1.jpg">
                <p>
                    <button>添加到购物车</button>
                </p>
                <p>亚瑟士ASICS跑步鞋2015春夏新款运动鞋男款避震跑鞋KAYANO T4H2N-9001 橙色/白色 42</p>
            </li>
            <li><img src="https://cyq0802.xin/img/demoImg/g2.jpg">
                <p>
                    <button>添加到购物车</button>
                </p>
                <p>亚瑟士ASICS运动鞋2015春夏新款跑步鞋女鞋稳定跑鞋KAYANO T4H7N-0701 黄色/白色 37.5</p>
            </li>
            <li><img src="https://cyq0802.xin/img/demoImg/g3.jpg">
                <p>
                    <button>添加到购物车</button>
                </p>
                <p>亚瑟士ASICS跑步鞋春夏透气稳定女款跑鞋 KAYANO T4N5N-3591 玫红色/黑色 37.5</p>
            </li>
            <li><img src="https://cyq0802.xin/img/demoImg/g4.jpg">
                <p>
                    <button>添加到购物车</button>
                </p>
                <p>亚瑟士ASICS高帮运动休闲鞋男鞋运动鞋DOUBLEH54XJ-5050 黑色/黑色 40.5</p>
            </li>
            <li><img src="https://cyq0802.xin/img/demoImg/g5.jpg">
                <p>
                    <button>添加到购物车</button>
                </p>
...
document.addEventListener('DOMContentLoaded',function(){
    ...
    goodsList.onclick = (e) => {
        if (e.target.tagName.toLowerCase() === 'button') {
            ...
            // 2> 动画飞入效果 animate是封装的动画函数，和jq的类似
...
```
## 效果展示
[飞入购物车效果](https://cyq0802.xin/demo/jsDemo/car.html)